...
abstract: In this paper, a cooperative navigation algorithm for team of mobile agents is presented. The proposed algorithm is a loosely coupled decentralized algorithm. The setting we consider consists of a set of mobile agents with sensing, processing and communication capabilities. In this setting each agent maintains a local filter to propagate and update its local pose estimates using selfmotion measurements and occasional external absolute measurement signals. Whenever, an agent
